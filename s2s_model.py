...
class s2s:
    ...
    def prediction(path, str):
        ...
        model = Chatbot(size_layer, num_layers, embedded_size, vocabulary_size_from + 4, vocabulary_size_to + 4,
        ...
        checkpoint_file = tf.train.latest_checkpoint(os.path.join('./dulieu/'+path, 'checkpoints_chatbot'))
